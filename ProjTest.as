...
;main.c: 178: if(getAdCh14Value() > 1951)
...
l3507:	
;main.c: 201: {
;main.c: 203: if(getAdCh4Value() < 1911)
...
l3511:	
;main.c: 208: else if(getAdCh4Value() < 2067)
	fcall	_getAdCh4Value
	movlw	high(0813h)
	subwf	(1+(?_getAdCh4Value)),w
	movlw	low(0813h)
...
l3515:	
;main.c: 212: else if(getAdCh4Value() < 2204)
	fcall	_getAdCh4Value
	movlw	high(089Ch)
	subwf	(1+(?_getAdCh4Value)),w
	movlw	low(089Ch)
...
l3519:	
;main.c: 216: else if(getAdCh4Value() < 2340)
	fcall	_getAdCh4Value
	movlw	high(0924h)
	subwf	(1+(?_getAdCh4Value)),w
	movlw	low(0924h)
...
;; Defined at:
;;		line 186 in file "C:\190604\AK7030-OTP\common.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
