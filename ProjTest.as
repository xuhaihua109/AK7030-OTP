...
??_getAdOriginaCh4Value:	; 0 bytes @ 0x28
	global	??_main
??_main:	; 0 bytes @ 0x28
;;Data sizes: Strings 0, constant 0, data 1, bss 141, persistent 0 stack 0
...
l4134:	
;common.c: 276: if(sampleTimes < 12)
	movlw	(0Ch)
...
l4150:	
;common.c: 300: if(sampleTimes >= 12)
	movlw	(0Ch)
	subwf	(_sampleTimes),w
	skipc
	goto	u1221
...
l4168:	
;common.c: 324: }
;common.c: 326: for(unsigned char index = 0; index < 12;index++)
...
;common.c: 53: unsigned int filter_temp = 0, filter_sum = 0;
	...
	line	57
;common.c: 55: unsigned int filter_buf[12];
;common.c: 57: for(int cir = 0;cir < 12; cir++)
	clrf	(Filter@cir)
	clrf	(Filter@cir+1)
	line	58
...
l3982:	
;common.c: 62: {
;common.c: 63: for(i = 0; i < 12 - 1 - j; i++)
	clrf	(Filter@i)
	goto	l3990
	line	65
...
l4006:	
;common.c: 80: }
;common.c: 82: return (filter_sum >> 3);
...
i1l4014:	
;common.c: 104: {
;common.c: 105: if(ucChannelFirstLength < 12)
	movlw	(0Ch)
...
i1l4026:	
;common.c: 119: {
;common.c: 120: if(ucChannelFourthLength < 12)
	movlw	(0Ch)
	bcf	status, 5	;RP0=0, select bank0
...
i1l4038:	
;common.c: 134: {
;common.c: 135: if(ucChannelFourteenthLength < 12)
	movlw	(0Ch)
	bcf	status, 5	;RP0=0, select bank0
...
;common.c: 154: ucChannelFourteenthLength = 0;
	clrf	(vPutSampleDataIntoTable@ucChannelFourteenthLength)
	line	156
;common.c: 156: for(int i = 0;i < 12; i++)
