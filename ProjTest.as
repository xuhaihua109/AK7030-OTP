...
# 101 "D:\develop\190625\AK7030-OTP\main.c"
	psect config,class=CONFIG,delta=2 ;#
# 101 "D:\develop\190625\AK7030-OTP\main.c"
	dw 0x3BFF & 0x3FBF & 0x3FFF & 0x3FFE ;#
# 102 "D:\develop\190625\AK7030-OTP\main.c"
	psect config,class=CONFIG,delta=2 ;#
# 102 "D:\develop\190625\AK7030-OTP\main.c"
	dw 0X3EFF & 0x3FFF & 0x3FFF & 0x3FF8 ;#
...
;; *************** function _main *****************
;; Defined at:
;;		line 515 in file "D:\develop\190625\AK7030-OTP\main.c"
...
l3623:	
;main.c: 522: static unsigned char ucWaitTime1S = 0;
;main.c: 524: static unsigned char ucWaitTimeO3s = 0;
;main.c: 526: static unsigned char ucSmallTimerActionFlag = 0;
;main.c: 528: static unsigned char ucSetSmallActionFlag = 0;
;main.c: 530: static unsigned char bCheckTweHour = 0;
;main.c: 532: static unsigned char bCheckTheHour = 0;
;main.c: 548: initPin();
	fcall	_initPin
	line	549
;main.c: 549: setPinInitVaule();
	fcall	_setPinInitVaule
	line	550
	
l3625:	
;main.c: 550: selectAdChannel();
	fcall	_selectAdChannel
	line	560
	
l3627:	
;main.c: 560: clock_config();
	fcall	_clock_config
	line	561
	
l3629:	
;main.c: 561: timer1_config();
	fcall	_timer1_config
	line	562
	
l3631:	
;main.c: 562: timer1_interrupt_config();
	fcall	_timer1_interrupt_config
	line	564
;main.c: 564: adc_test_init(12,3);
	movlw	(03h)
...
l3633:	
;main.c: 571: adc_start();
	fcall	_adc_start
	line	581
	
l3635:	
;main.c: 581: startTwentyMinTimer( 1200 );
	movlw	low(04B0h)
...
l3637:	
# 586 "D:\develop\190625\AK7030-OTP\main.c"
 clrwdt ;#
psect	maintext
	line	588
	
l3639:	
;main.c: 588: process_AD_Converter_Value();
	fcall	_process_AD_Converter_Value
	line	590
	
l3641:	
;main.c: 590: if( isPermitSampleTime() )
...
l3643:	
;main.c: 591: {
;main.c: 594: clrSampeTime();
	fcall	_clrSampeTime
	line	609
;main.c: 608: static unsigned char ucStep = 0;
;main.c: 609: switch(ucStep)
	goto	l3811
	line	615
	
l3645:	
;main.c: 612: {
;main.c: 613: static unsigned char ucTimerP3s = 0;
;main.c: 615: if( isFinishedTwentyMinTimer() )
...
;main.c: 617: else
;main.c: 618: {
;main.c: 619: if( getAdOriginalCh13Value() > 1000 )
...
l3655:	
;main.c: 628: }
;main.c: 631: if( getAdOriginalCh12Value() > 1000 )
...
l3661:	
;main.c: 641: }
;main.c: 643: static unsigned char ucDebug1 = 0;
;main.c: 645: static unsigned char ucDebug2 = 0;
;main.c: 647: ucDebug1++;
	incf	(main@ucDebug1),f
	line	649
	
l3663:	
;main.c: 649: if( ucDebug1 < 10 )
	movlw	(0Ah)
...
l3667:	
;main.c: 651: else if((ucDebug1 >= 10) && ( ucDebug1 < 20))
	movlw	(0Ah)
	subwf	(main@ucDebug1),w
	skipc
	goto	u1321
...
l3681:	
;main.c: 668: {
;main.c: 669: if( getAdOriginalCh12Value() > 1000 )
	fcall	_getAdOriginalCh12Value
	movlw	high(03E9h)
	subwf	(1+(?_getAdOriginalCh12Value)),w
	movlw	low(03E9h)
...
l3685:	
;main.c: 671: else
;main.c: 672: pwm_start(0x02);
	movlw	(02h)
	fcall	_pwm_start
	
l782:	
	line	674
;main.c: 674: pwm_config(1);
	movlw	(01h)
	fcall	_pwm_config
	line	675
;main.c: 675: setPB3(0);
...
l3687:	
;main.c: 678: clearTwentyMinTimer();
	fcall	_clearTwentyMinTimer
	line	679
	
l3689:	
;main.c: 679: startTwelveHourTimer( 36000);
	movlw	low(08CA0h)
...
l3693:	
;main.c: 685: {
;main.c: 686: static unsigned char ucTimerP5s = 0;
;main.c: 688: if( isFinishedTwelveHoursTimer () )
...
;main.c: 690: else
;main.c: 691: {
;main.c: 692: if( getAdOriginalCh13Value() < 200 )
	fcall	_getAdOriginalCh13Value
	movlw	high(0C8h)
	subwf	(1+(?_getAdOriginalCh13Value)),w
	movlw	low(0C8h)
...
l3701:	
;main.c: 694: else
;main.c: 695: ucTimerP5s = 0;
	clrf	(main@ucTimerP5s)
	line	697
	
l3703:	
;main.c: 697: if( ucTimerP5s > 5)
	movlw	(06h)
...
l3707:	
;main.c: 707: {
;main.c: 708: clearTwelveHoursTimer();
	fcall	_clearTwelveHoursTimer
	line	709
	
l3709:	
;main.c: 709: startThreeHoursTimer(10800);
	movlw	low(02A30h)
...
l3713:	
;main.c: 715: {
;main.c: 716: static unsigned char ucTimerP5s = 0;
;main.c: 718: if( isFinishedThreeHoursTimer() )
...
;main.c: 720: else
;main.c: 721: {
;main.c: 722: if( getAdOriginalCh13Value() < 85 )
	fcall	_getAdOriginalCh13Value
	movlw	high(055h)
	subwf	(1+(?_getAdOriginalCh13Value)),w
	movlw	low(055h)
...
l3729:	
;main.c: 737: {
;main.c: 738: clearThreeHoursTimer();
	fcall	_clearThreeHoursTimer
	line	739
	
l3731:	
;main.c: 739: startOneHoursTimer( 3600 );
	movlw	low(0E10h)
...
;main.c: 753: if( isFinishedOneHoursTimer() )
...
;main.c: 755: else
;main.c: 756: {
;main.c: 757: if( getAdOriginalCh13Value() > 100 )
	fcall	_getAdOriginalCh13Value
	movlw	high(065h)
	subwf	(1+(?_getAdOriginalCh13Value)),w
	movlw	low(065h)
...
l3751:	
;main.c: 762: else
;main.c: 763: uiTimerOneP5s = 0;
	clrf	(main@uiTimerOneP5s)
	clrf	(main@uiTimerOneP5s+1)
	line	765
	
l3753:	
;main.c: 765: if(uiTimerOneP5s > 5)
	movlw	high(06h)
...
;main.c: 775: else
;main.c: 776: {
;main.c: 777: if( getAdOriginalCh13Value() < 25 )
	fcall	_getAdOriginalCh13Value
	movlw	high(019h)
	subwf	(1+(?_getAdOriginalCh13Value)),w
	movlw	low(019h)
...
l3773:	
;main.c: 790: {
;main.c: 791: static unsigned int uiTimerP5s = 0;
;main.c: 792: if( getAdOriginalCh13Value() < 25 )
	fcall	_getAdOriginalCh13Value
	movlw	high(019h)
	subwf	(1+(?_getAdOriginalCh13Value)),w
	movlw	low(019h)
...
l3777:	
;main.c: 794: else
;main.c: 795: uiTimerP5s = 0;
	clrf	(main@uiTimerP5s)
	clrf	(main@uiTimerP5s+1)
	line	797
	
l3779:	
;main.c: 797: if(uiTimerP5s > 5)
	movlw	high(06h)
...
l3797:	
;main.c: 822: {
;main.c: 823: static unsigned char ucTimerP5s = 0;
;main.c: 824: if( getAdOriginalCh13Value() >50 )
	fcall	_getAdOriginalCh13Value
	movlw	high(033h)
	subwf	(1+(?_getAdOriginalCh13Value)),w
	movlw	low(033h)
...
;; *************** function _initPin *****************
;; Defined at:
;;		line 308 in file "D:\develop\190625\AK7030-OTP\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l3593:	
;main.c: 310: initPB2_AsHighResistence();
	fcall	_initPB2_AsHighResistence
	line	312
	
l3595:	
;main.c: 312: initPB3(0);
	movlw	(0)
	fcall	_initPB3
	line	314
	
l3597:	
;main.c: 314: initPB4(0);
	movlw	(0)
	fcall	_initPB4
	line	316
	
l3599:	
;main.c: 316: initPB5(0);
	movlw	(0)
	fcall	_initPB5
	line	321
...
;; *************** function _reset *****************
;; Defined at:
;;		line 354 in file "D:\develop\190625\AK7030-OTP\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; Defined at:
;;		line 345 in file "D:\develop\190625\AK7030-OTP\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; Defined at:
;;		line 335 in file "D:\develop\190625\AK7030-OTP\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; Defined at:
;;		line 300 in file "D:\develop\190625\AK7030-OTP\main.c"
;; Parameters:    Size  Location     Type
